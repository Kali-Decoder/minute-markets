...
// Mock configurations matching your front-end asset schemas
export const getPredictionMarketFactoryAddress = (chainId: number): `0x${string}` => {
  return (process.env.FACTORY_ADDRESS as `0x${string}`) || "0x0000000000000000000000000000000000000000";
};

// Insert your respective system ABIs here
      ...
      "outputs": [
        {
          "components": [
            ...
            {
              "internalType": "enum PredictionMarket.RoundStatus",
              "name": "status",
              "type": "uint8"
            }
          ],
